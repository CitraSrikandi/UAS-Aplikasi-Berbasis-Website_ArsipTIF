<div class="container">
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang Sistem Pengelolaan Surat Masuk dan Keluar Teknologi Informasi</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Halaman Awal</h3>
                </div>
    ...
    <tr>
        <td align="center">
            <img src="img/animasi surat 2.jpg" style="width: 70%; max-width: 500px;" />
        </td>
    </tr>
</tbody>
